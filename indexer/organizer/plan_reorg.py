...
def main() -> None:
    ...
    if not tag_plan_path.exists():
        raise SystemExit(f"Tag plan not found: {tag_plan_path}")
    ...
    payload_json, tag_lookup, original_tags = prepare_prompt_payload(catalog, tag_plan)
